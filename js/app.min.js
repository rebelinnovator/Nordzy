(() => {
  ...
  const D = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              M = e.isHorizontal() ? T(r, "width", !0) : T(r, "height", !0);
            else {
              const e = i(o, "width"),
                t = i(o, "padding-left"),
                s = i(o, "padding-right"),
            ...
            (M = (o - (s.slidesPerView - 1) * x) / s.slidesPerView),
              s.roundLengths && (M = Math.floor(M)),
              p[n] && (p[n].style[t("width")] = `${M}px`);
          p[n] && (p[n].swiperSlideSize = M),
            m.push(M),
            s.centeredSlides
              ? ((E = E + M / 2 + I / 2 + x),
                0 === I && 0 !== n && (E = E - o / 2 - x),
      ...
      if (
        ...
        O && e.grid.updateWrapperSize(M, h, t),
        !s.centeredSlides)
      ) {
        const t = [];
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        o = (e) => b(s, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
      let a;
      if (
        (t.forEach((e) => {
          e.classList.remove(
  ...
  const B = {
    ...
    slidePrev: function (e = this.params.speed, t = !0, i) {
      ...
      const u = p(a ? s.translate : -s.translate),
        h = r.map((e) => p(e));
  ...
  const F = {
    loopCreate: function (e) {
      ...
      b(s, `.${i.slideClass}, swiper-slide`).forEach((e, t) => {
    ...
    loopFix: function ({
      ...
      if (n < g) {
        ...
        S = Math.max(n - (a.slides.length - 2 * g), u.slidesPerGroup);
        for (let e = 0; e < S; e += 1) {
          const t = e - Math.floor(e / l.length) * l.length;
          f.push(t);
        }
  ...
  function H(e) {
    ...
    u && l.target && l.target.shadowRoot && g && (c = g[0]);
  ...
  function V(e) {
    ...
    const p = s.evCache.length > 1 ? s.evCache[0] : l,
      u = p.pageX,
      g = p.pageY;
    if (l.preventedByNestedSwiper) return (r.startX = u), void (r.startY = g);
    if (!i.allowTouchMove)
      return (
  ...
  class te {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: i } = this,
        s = C(b(t, `.${i.slideClass}, swiper-slide`)[0]);
      return C(e) - s;
    }
    ...
    return (
      e.params.createElements &&
        Object.keys(s).forEach((n) => {
          if (!i[n] && !0 === i.auto) {
            let r = b(e.el, `.${s[n]}`)[0];
            r || ((r = w("div", s[n])), (r.className = s[n]), e.el.append(r)),
              (i[n] = r),
              (t[n] = r);
          }
        }),
  ...
  function oe({ swiper: e, extendParams: t, on: i, emit: s }) {
    ...
    function c(t) {
      const i = t.target.closest(re(e.params.pagination.bulletClass));
      if (!i) return;
      t.preventDefault();
      const s = C(i) * e.params.slidesPerGroup;
      if (e.params.loop) {
    ...
    function p() {
      ...
      if (
          ...
          ? ((c = e.previousRealIndex || 0),
            (n =
              e.params.slidesPerGroup > 1
                ...
                : e.realIndex))
          : void 0 !== e.snapIndex
          ? ((n = e.snapIndex), (c = e.previousSnapIndex))
          : ((c = e.previousIndex || 0), (n = e.activeIndex || 0)),
        "bullets" === i.type &&
        ...
        if (
          (i.dynamicBullets &&
            ((r = T(s[0], e.isHorizontal() ? "width" : "height", !0)),
            p.forEach((t) => {
      ...
      p.forEach((t, r) => {
        if (
          ("fraction" === i.type &&
            (t.querySelectorAll(re(i.currentClass)).forEach((e) => {
              e.textContent = i.formatFractionCurrent(n + 1);
            }),
            t.querySelectorAll(re(i.totalClass)).forEach((e) => {
          ...
          "horizontal" === s ? (o = r) : (a = r),
            t.querySelectorAll(re(i.progressbarFillClass)).forEach((t) => {
          ...
          "custom" !== t.type && (i.innerHTML = r || ""),
            "bullets" === t.type &&
              e.pagination.bullets.push(
                ...i.querySelectorAll(re(t.bulletClass))
              );
        }),
      ...
      "string" == typeof t.el &&
        ...
        i &&
          ...
          (e.params.uniqueNavElements &&
            ...
            i.length > 1 &&
              (i = i.filter((t) => x(t, ".swiper")[0] === e.el)[0])),
  ...
  function ae({ swiper: e, extendParams: t, on: i, emit: s, params: n }) {
    let r, o;
    ...
    function y(t) {
      e &&
        ...
        (e.wrapperEl.removeEventListener("transitionend", y), T());
    }
    const b = () => {
        if (e.destroyed || !e.autoplay.running) return;
        e.autoplay.paused ? (l = !0) : l && ((f = a), (l = !1));
        const t = e.autoplay.paused ? a : v + f - new Date().getTime();
        (e.autoplay.timeLeft = t),
          s("autoplayTimeLeft", t, t / m),
      ...
      x = (t, i) => {
        ...
        if (((e.autoplay.paused = !0), i))
          return h && (a = e.params.autoplay.delay), (h = !1), void n();
        const o = a || e.params.autoplay.delay;
        (a = o - (new Date().getTime() - v)),
          (e.isEnd && a < 0 && !e.params.loop) || (a < 0 && (a = 0), n());
      },
      T = () => {
      ...
      E = () => {
        if (e.destroyed || !e.autoplay.running) return;
        const t = d();
        "hidden" === t.visibilityState && ((g = !0), x(!0)),
          "visible" === t.visibilityState && T();
      },
      I = (e) => {
        "mouse" === e.pointerType && ((g = !0), x(!0));
      },
      L = (t) => {
    ...
    i("init", () => {
      ...
      i("beforeTransitionStart", (t, i, s) => {
        !e.destroyed &&
          e.autoplay.running &&
          (s || !e.params.autoplay.disableOnInteraction ? x(!0, !0) : C());
      }),
      i("sliderFirstMove", () => {
        !e.destroyed &&
          e.autoplay.running &&
      ...
      Object.assign(e.autoplay, { start: S, stop: C, pause: x, resume: T });
  }
  window.addEventListener("load", function (e) {
    document.querySelector(".apartments__slider") &&
      new ie(".apartments__slider", {
        modules: [ne, oe],
        observer: !0,
        observeParents: !0,
        slidesPerView: 3,
        ...
        autoHeight: !0,
        speed: 800,
        pagination: { el: ".apartments__pagination", clickable: !0 },
        navigation: {
      ...
      document.querySelector(".gallery__slider") &&
        new ie(".gallery__slider", {
          ...
          breakpoints: {
            ...
            580: { slidesPerView: 4, spaceBetween: 5 },
  ...
  e.watcher = new (class {
    ...
    scrollWatcherLogging(e) {
      this.config.logging && n(`[Спостерігач]: ${e}`);
    }
...
***************************************************************************** */
      ...
      return (
        ...
        (e.prototype.hideScrollbar = function () {
          if (this.shouldHideScrollbar()) {
            this.bodyPaddingRight = parseFloat(ke("body").style().paddingRight);
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, i, s, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(ye, { index: t, delay: i || 0, isFirstSlide: n });
          }, a);
        }),
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              C = He(r, x || "", g, this.settings.strings.playVideo, h);
              n.prepend(C);
            } else if (h) {
          ...
          var E = 0;
          v && !ke(document.body).hasClass("lg-from-hash") && (E = v),
            this.isFirstSlideWithZoomAnimation() &&
              (setTimeout(function () {
                n.removeClass(
          ...
          this.settings.enableDrag &&
            ...
            ke(window).on("mouseup.lg.global" + this.lgId, function (r) {
              if (e.lgOpened) {
                var o = ke(r.target);
                n
                  ? ((n = !1), e.touchEnd(i, t, r), e.LGel.trigger(Te))
                  : e.isPosterElement(o) && e.LGel.trigger(Se),
                  s &&
                    ((s = !1),
          ...
          return (
            ...
            setTimeout(function () {
              t.zoomFromOrigin &&
                ...
                t.$inner.empty(),
                t.lgOpened && t.LGel.trigger(Oe, { instance: t }),
  ...
  new (class {
    ...
    window.addEventListener("load", function () {
      const e = document.querySelector(".top-overlay"),
        t = document.querySelector(".bottom-overlay"),
        i = document.querySelector(".overlay-top-close"),
        s = document.querySelector(".overlay-bottom-close"),
        n = document.querySelector(".intro__button");
      e &&
        ...
        s.addEventListener("click", function (e) {
          e.preventDefault(), t.classList.add("_close");
        }));
      if (t) {
        function d() {
          var e = document.body,
      ...
      const r = document.getElementById("minutes"),
        o = document.getElementById("seconds"),
        a = document.getElementById("minutes-circle"),
        l = document.getElementById("seconds-circle");
      if (r) {
        const c = parseFloat(r.getAttribute("data-minutes"));
        let p = 60 * c;
        const u = r,
          h = o;
        function g() {
          ...
          if (
            ...
            (u.innerHTML = `${e}`),
            (h.innerHTML = `${t}`),
            (a.style.strokeDashoffset = 113 - (113 * e) / 10),
            (l.style.strokeDashoffset = 113 - (113 * t) / 60),
            p--,
            p < 0)
          )
            return (
              (r.textContent = "0"),
              (o.textContent = "0"),
              (a.style.strokeDashoffset = 113),
              (l.style.strokeDashoffset = 113),
